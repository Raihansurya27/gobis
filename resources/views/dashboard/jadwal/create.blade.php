        ...
        <div class="col-lg-6">
            <form action="{{url('/jadwal')}}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    @enderror" id="nama" placeholder="Contoh: Spesial Lebaran" name="nama" value="{{ucwords(old('nama'))}}">
                    @error('nama')
                        {{$message}}
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    @enderror" id="keberangkatan" name="keberangkatan" value="{{ucwords(old('keberangkatan'))}}">
                    @error('keberangkatan')
                        {{$message}}
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    @enderror" id="harga" placeholder="Contoh: 50000" name="harga" value="{{ucwords(old('harga'))}}">
                    @error('harga')
                        {{$message}}
                    @enderror
                </div>
