...
<body>
  ...
  <div class="tentangkami">
    ...
    <div class="card">
      <h3>Siapa Kami ?</h3>
      <p>GO-BIS adalah platform pemesanan tiket bus online terbesar di dunia, yang menghubungkan berbagai kota di seluruh dunia dengan hanya klik satu tombol. Didirikan pada tahun 2006, GO-BIS menjual lebih dari 40 juta tiket hingga saat ini. Kami adalah bagian dari Grup ibibo dan didanai oleh Naspers (sebuah perusahaan multinasional Afrika Selatan). Naspers mengubah industri e-commerce di lebih dari 135 negara yang beroperasi dengan menggunakan layanan internet, TV berbayar, dan media cetak. </p>
    </div>
    <div class="card">
      <h3>Mengapa memesan tiket bus kepada kami ?</h3>
      <p>GO-BIS menyediakan bus wisatawan dengan sistem pemesanan yang paling sederhana dan tidak repot. Pilih tujuan Anda, lihat susunan posisi kursi, pilih kursi yang nyaman, dan pesan tiket Anda hanya dalam beberapa klik! Pengalaman GO-BIS tidak berakhir hanya dengan pemesanan. Kami memiliki timlayananpelanggan khusus untuk memenuhi semua kebutuhan Anda saat Anda berada di perjalanan. Kami mengharapkan umpan balik dari para pelanggan kami secara berkala dan selalu berusaha untuk memperbaiki diri! p>
    </div>
    <div class="card">
      <h3>Perjalanan Kami </h3>
        ...
        <p>2011 - Teknologi kami beradadi antara 5 pemenang teratas pada ajang penghargaan bergengsi CIO Asia Award di Singapura</p>
        <p>2012- 10 juta tiket terjual. Mendapatkan penghargaan Marico Innovation Awards. Menerima hadiah penghargaan Porter pada ajang penghargaan IFC Mint Strategy Awards</p>
